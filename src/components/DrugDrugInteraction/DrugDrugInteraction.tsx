...
function DrugDrugInteraction({ medication }: props) {
      ...
      <div className="w-full h-[200px] rounded-2xl font-sans">
        ...
        <div className="w-full h-[90%] border rounded-2xl font-sans bg-red-50 flex items-center justify-center">
          <div className="text-center">
            ...
            <p className="font-semibold text-red-500">Error fetching interaction data</p>
          </div>
        </div>
      </div>
    );
          ...
          {data?.text[0] === "No" ? (
            <div className="relative p-6 bg-green-50">
              <div className="flex items-center mb-4">
                ...
                <span className="font-semibold text-green-700">No Interaction Found</span>
              </div>
            ...
            <div>
              <div className="relative p-4 bg-red-50 border-b border-red-100">
                <div className="flex items-center mb-1">
                  ...
                  <span className="font-semibold text-red-700">{data?.text[2]}</span>
                </div>
